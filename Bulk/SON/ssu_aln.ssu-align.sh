...
for (( i=1; i<=19; i++ ))
do
	echo "# Executing: ssu-align -b 50 --dna --rfonly data/tmp/ssu_aln/otusn_JSON.pick.fasta.$i data/tmp/ssu_aln/ssu_aln.$i > /dev/null &"
	ssu-align -b 50 --dna --rfonly data/tmp/ssu_aln/otusn_JSON.pick.fasta.$i data/tmp/ssu_aln/ssu_aln.$i > /dev/null &
done
echo "# Executing: ssu-align --merge 20 -b 50 --dna --rfonly data/tmp/ssu_aln/otusn_JSON.pick.fasta.20 data/tmp/ssu_aln/ssu_aln.20"
ssu-align --merge 20 -b 50 --dna --rfonly data/tmp/ssu_aln/otusn_JSON.pick.fasta.20 data/tmp/ssu_aln/ssu_aln.20
